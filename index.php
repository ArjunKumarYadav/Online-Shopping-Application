...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="d-block w-100" src="image/slider/banner-1.jpg" alt="First slide" style="min-height: 600px">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="image/slider/banner-1.jpg" alt="Second slide" style="min-height: 600px">
        </div>
        <div class="carousel-item">
            <img class="d-block w-100" src="image/slider/banner-1.jpg" alt="Third slide" style="min-height: 600px">
        </div>
    </div>
